...
const Home: NextPage = () => {
  ...
  return (
    <>
      <Head>
        <title>Akapz DAO</title>
      </Head>

      <Heading as="h3"  my={4}>Welcome to Akapz DAO</Heading>          
      <VStack>
      <Box w='100%' my={4}>
        {currentAccount  
        ...
        :<></>
         ...
         <Box  mb={0} p={4} w='100%' borderWidth="1px" borderRadius="lg">
          <Heading my={4}  fontSize='xl'>Akapz DAO Token Info</Heading>
          <ReadERC20 
            addressContract='0xdc64a140aa3e981100a9beca4e685f962f0cf6c9'
